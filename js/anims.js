...
var modal = null;
const ShowModal = () => {
    if (modalWrap !== null) // do not create multiple modal boxes
    {
        modalWrap.remove();
    }
    ...
    modalWrap.innerHTML = `
    <div class="modal fade" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="true">
        <div class="modal-dialog modal-fullscreen">
            <div class="modal-content">
                <!--<div class="modal-body">-->
                    <canvas id="dntTouchCanvas" width="400" height="400"></canvas>
                <!--</div>-->
            </div>
        </div>
    </div>
...
const dntTouchBtn = document.getElementById("dnt-touch-btn");
dntTouchBtn.addEventListener("click", function(){
    ShowModal();
});

/* Animations */
const beautifulStarsAnim = {
    Play: () => {
        console.log("beautiful stars");
...
const animationsArr = [];
animationsArr.push(beautifulStarsAnim);

const Animate = () => {
    const randomIndex = 0;
    animationsArr[randomIndex].Play();
};